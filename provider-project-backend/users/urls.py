...
from users.viewsets import BusinesViewSet, IndividualViewSet, CollaboratorUsersViewSet, PermissionViewSet,UsersViewSet, UserAccountViewSet, UserContactViewSet
...
router.register(r'api/users/collaborator',
                CollaboratorUsersViewSet,
                basename='CollaboratorView')
router.register(r'api/users/individual',
                IndividualViewSet,
                basename='IndividualView')
