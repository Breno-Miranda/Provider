...
from users.viewsets import BusinesViewSet, IndividualViewSet, CollaboratorUsersViewSet, ForgotThePasswordUsersViewSet , PermissionViewSet, UsersViewSet
...
router.register(r'api/users/forgot-password', ForgotThePasswordUsersViewSet, basename='ForgotThePassword')
