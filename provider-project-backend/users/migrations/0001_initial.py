    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_bind', models.ForeignKey(blank=True, null=True, on_delete=None, related_name='person_individual_bond', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'managed': True,
            },
        ...
        migrations.AddField(
            model_name='bind',
            name='sector',
            field=models.ForeignKey(on_delete=None, to='users.Sector'),
        ),
        migrations.AddField(
            model_name='bind',
            name='team',
        ...
        migrations.AddField(
            model_name='bind',
            name='user',
            field=models.ForeignKey(on_delete=None, related_name='person_bind', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='Bank_Account',
            fields=[
