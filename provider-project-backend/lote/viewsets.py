...
from .serializers import LotsSerializers
...
class LotsViewset(viewsets.ViewSet):
 
    def list(self, request):
        
        companyId = request.GET.get('company_id', None)

        queryset = LotsSerializers(Lote.objects.all().filter(company_id=companyId), many=True)
    ...
    def create(self , request):
        ...
        serializer = LotsSerializers(data=request.data)
